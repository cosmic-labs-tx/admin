...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create fbl-admin-eb6f
  fly apps create fbl-admin-eb6f-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app fbl-admin-eb6f
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app fbl-admin-eb6f-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'fbl-admin-eb6f-staging' does not match app name in config file 'fbl-admin-eb6f'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name fbl-admin-eb6f-db
  fly postgres attach --app fbl-admin-eb6f fbl-admin-eb6f-db

  fly postgres create --name fbl-admin-eb6f-staging-db
  fly postgres attach --app fbl-admin-eb6f-staging fbl-admin-eb6f-staging-db
  ```
