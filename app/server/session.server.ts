...
export async function requireUser(request: Request, allowedRoles?: Array<Role>) {
  const defaultAllowedRoles: Array<Role> = ["CLIENT_ADMIN", "CLIENT_USER", "CLIENT_ACCOUNTANT", "SUPER_ADMIN"];
